...
\section{Časť 1: Exploračná dátová analýza}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../figures/eda_target_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/eda_monthly_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/eda_sample_images.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/eda_split_distributions.png}
...
\section{Časť 2: Konvolučné neurónové siete (CNN)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.05\textwidth]{../figures/custom_images_predictions_config_5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.05\textwidth]{../figures/bonus_prediction_15min.png}
    \caption{Výsledky predikcie žiarenia o~15 minút}
    \label{fig:prediction_15min}
\end{figure}

\textbf{Záver:} Predikcia budúceho žiarenia je výrazne ťažšia úloha kvôli dynamickým zmenám oblačnosti.

\clearpage

\section{Časť 3: Transfer Learning a~zhlukovanie}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/clusters_2d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/average_cluster_images.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/cluster_irradiance_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/transfer_learning_residuals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/transfer_learning_predictions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/worst_predictions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/bonus_fusion_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../figures/bonus_fusion_metrics.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/bonus_fusion_feature_importance.png}
    \caption{Dôležitosť príznakov vo fúznom modeli}
    \label{fig:feature_importance}
\end{figure}

\textbf{Záver:} Fúzia obrazových a~tabuľkových príznakov prináša mierne zlepšenie oproti samotným obrazovým príznakom.
